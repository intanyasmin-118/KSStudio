...
<head>
    ...
    <style>
        ...
        .cards{margin-top:10px; display:grid; grid-template-columns:repeat(3, minmax(0,1fr)); gap:14px;}
...
<div class="container">
    ...
    <div class="page-box">
        ...
        <div class="subtitle">Revenue trend per month, total transactions, and top packages</div>
        ...
        <div class="cards">
            ...
            <div class="card">
                <div class="label">Months Recorded</div>
                <div class="value">{{ $monthly->count() }}</div>
            </div>
        </div>
