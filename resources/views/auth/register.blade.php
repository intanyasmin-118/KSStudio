...
.admin-secret-link {
    ...
    background: transparent;
    color: transparent; /* Symbol is hidden */
    text-decoration: none;
...
.admin-secret-link:hover {
    background: rgba(0, 0, 0, 0.05); /* Very light grey square appears */
    border: 1px solid #ddd;
    color: #333; /* Symbol becomes visible */
...
.admin-symbol {
    ...
    <a href="/admin/register" class="admin-secret-link" title="Admin Access">
    <span class="admin-symbol">⚙</span>
</a>
</head>
